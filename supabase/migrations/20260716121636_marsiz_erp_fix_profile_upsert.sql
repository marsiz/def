/*
# Fix auto_setup_admin: use ON CONFLICT for profile insert
- The handle_new_user trigger creates a user_profiles row on auth.users insert
- auto_setup_admin must UPDATE the existing row instead of INSERT
*/
