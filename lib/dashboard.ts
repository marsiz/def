...
export async function getDashboardStats(): Promise<DashboardStats> {
  ...
  return {
    ...
    stockValue,
    lowStockCount: 0,
    todayPct: { change: '0%', trend: 'up' as const },
    monthSalesPct: { change: '0%', trend: 'up' as const },
    expensesPct: { change: '0%', trend: 'up' as const },
    profitPct: { change: '0%', trend: 'up' as const },
    customerPct: { change: '0%', trend: 'up' as const },
    topProducts,
